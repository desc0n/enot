                    ...
                    <div class="item-pageleftlarge">
                        <div class="article_header">
                            <div class="article_date"><div class="article_date_pad">
                                    <?
                                    $month = Date::strftime_fix('%b', strtotime($content['publish_up']));

                                    $date = DateTime::createFromFormat('Y-m-d H:i:s', $content['publish_up']);
                            ...
                            <div class="article_info">
                                <h2 class="title">
                                    <a href="<?=Arr::get($content, 'path');?>">
                                        <?=Arr::get($content, 'title');?>
                                    </a>
                                </h2>
                            	<span class="published">Опубликовано: <?=$date->format('d.m.Y H:i');?>&nbsp;</span>
                            </div>
                            <div style="clear:both;"></div>
                        </div>
                        <div class="article_text">
                            <?=Arr::get($content, 'fulltext');?>
                        </div>
                    </div>
                </div>
            </div>
